...
| 010 | **Erledigt (2026-07-15).** CI-Gate `eigenlag check --against REF`: Worktree-Vergleich, Punkt-λ gegen Punkt-λ (ADR-022), Exit-Codes 0/1/3, PR-Kommentar mit auslösender Kante (Datei:Zeile) und Behebungs-Hinweis, GitHub-Actions-Beispiel in `docs/ci-gate.md`. Dazu die beiden 009a-Report-Korrekturen (Null-Delta-Sammelzeile, Schlusssatz) | 009 |
