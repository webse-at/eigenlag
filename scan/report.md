...
| Repos mit mindestens einem DAG | 1286 |

Fehler-Kategorien aus `data/scan_errors.jsonl`:

| Kategorie | Vorkommen |
|---|---|
| `syntax_error` | 7593 |
| `unresolved_default_args` | 5641 |
| `ambiguous_task` | 428 |
| `yaml_error` | 29 |
| `clone_failed` | 1 |
...
**Nenner ist der DAG, nicht das Repo und nicht das File: 51426 DAGs.**
...
| **Risiko-Kandidaten (Cross-Run **und** sub-täglich im selben DAG)** | **176** | **0.3 %** |
| Repos mit mindestens einem Risiko-Kandidaten | 100 | — |

Schedule-Klassen:

| Klasse | DAGs | Anteil |
|---|---|---|
| `daily_or_slower` | 27245 | 53.0 % |
| `none` | 18756 | 36.5 % |
| `unknown` | 2686 | 5.2 % |
| `subdaily` | 2543 | 4.9 % |
...
|---|---|---|---|
| `sig_a_depends_on_past` | 958 | 1.9 % | ja |
| `sig_b_wait_for_downstream` | 192 | 0.4 % | ja |
| `sig_c_ext_sensor_delta` | 318 | 0.6 % | ja |
| `sig_d_include_prior_dates` | 0 | 0.0 % | ja |
| `sig_f_prev_success_tmpl` | 5 | 0.0 % | ja |
...
|---|---|---|---|---|
| `jcw024/lichess_database_ETL` (212★) | `lichess_ETL_pipeline_kafka` | `timedelta(minutes=5)` | depends_on_past | [src/airflow_dag_kafka.py:48](https://github.com/jcw024/lichess_database_ETL/blob/9596bfdb0167f1e86ccc71d168aa354fee617654/src/airflow_dag_kafka.py#L48) |
...
| `unresolved_default_args` | 5641 Fälle in 148 Repos | `default_args` aus Import oder dynamischer Konstruktion. Ein `depends_on_past=True` darin ist unsichtbar, wird aber nicht geraten. |
| Ambige Tasks | 428 Fälle in 49 Repos | Operator ohne DAG-Bindung in einem File mit mehreren DAGs. Wird nicht geraten. |
